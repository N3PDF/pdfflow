...
class Subgrid:
    ...
    def ledge_interpolation(self, a_x, a_q2, actual_values):
        ...
        """
        a2, a3, a4 = l_four_neighbour_knots(
            a_x, a_q2, self.log_x, self.log_q2, actual_values
        )
    ...
    def redge_interpolation(self, a_x, a_q2, actual_values):
        ...
        ----------
            ...
            a_q2: tf.tensor
                query of values of log(q2)
        """
        a2, a3, a4 = r_four_neighbour_knots(
            a_x, a_q2, self.log_x, self.log_q2, actual_values
        )
    ...
    def uedge_interpolation(self, a_x, a_q2, actual_values):
        ...
        ----------
            ...
            a_q2: tf.tensor
                query of values of log(q2)
        """
        a2, a3, a4 = u_four_neighbour_knots(
            a_x, a_q2, self.log_x, self.log_q2, actual_values
        )
    ...
    def dedge_interpolation(self, a_x, a_q2, actual_values):
        ...
        ----------
            ...
            a_q2: tf.tensor
                query of values of log(q2)
        """
        a2, a3, a4 = d_four_neighbour_knots(
            a_x, a_q2, self.log_x, self.log_q2, actual_values
        )
    ...
    def lowq2_extrapolation(self, u, a_x, a_q2):
        ...
        anom = tf.where(
            mask,
            tf.maximum(
                tf.constant(-2.5, dtype=float64), (fq2Min1 - fq2Min) / fq2Min / 0.01
            ),
    ...
    def lowx_lowq2_extrapolation(self, u, a_x, a_q2):
        ...
        f = self.interpolate(
            u, tf.concat([corn_x, corn_x], 0), tf.concat([corn_q2, 1.01 * corn_q2], 0)
        )
        ...
        anom = tf.where(
            mask,
            tf.maximum(tf.constant(-2.5, dtype=float64), (fq2Min1 - fq2Min) / fq2Min / 0.01),
            tf.constant(1, dtype=float64),
        )
